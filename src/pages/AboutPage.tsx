    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6">
          <p className="text-lg">
            Welcome to NeonMeet.com, your premier platform for connecting with verified companions and event partners. Founded with the vision of creating meaningful connections, we strive to provide a safe, respectful, and professional environment for our community.
          </p>
